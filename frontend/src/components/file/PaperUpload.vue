...
const handleKeywordClose = (tag: string) => {
...
// 生成封面
const generateCover = async (file: File): Promise<string> => {
    try {
      ...
      <div v-else class="py-2">
        <el-form ref="formRef" :model="formData" :rules="rules" label-width="80px">
          <el-form-item :label="t('file.upload.form.file')">
            ...
            <div v-if="formData.coverUrl" class="mt-2 w-32 h-40 border border-gray-200 rounded overflow-hidden">
                <img :src="formData.coverUrl" class="w-full h-full object-cover bg-white" alt="Cover" />
            </div>
          </el-form-item>
