    ...
    <div class="w-full md:w-1/2 flex items-center justify-center p-8 md:p-16 relative">
      <div class="w-full max-w-[420px]">
        ...
        <div class="flex justify-between items-center text-sm mt-6 mb-8">
          <router-link to="/user/forgot-password" class="text-blue-600 hover:underline transition-colors">
            忘记密码？
          </router-link>
          <router-link to="/user/register" class="font-medium text-blue-600 hover:underline transition-colors">
            立即注册
          </router-link>
        </div>
